"""
Migration: Add 5 level title columns to diagram_images table.
...
These columns store the hierarchy level titles for each diagram,
allowing users to position diagrams within the book structure.

Run this migration from the 03-code directory:
    python migrate_add_level_titles.py
"""
...
def add_level_title_columns(table_prefix: str):
    """Add the 5 level title columns to a diagram_images table."""
...
def run_migration():
    ...
    print("=" * 60)
    print("Migration: Add Level Title Columns to Diagram Images")
    print("=" * 60)
    ...
    for prefix in table_prefixes:
        print(f"Migrating: raw_{prefix}_diagram_images")
        try:
